        ...
        <Page size="A4" style={styles.page}>
          ...
          <View style={[styles.pageBorder, styles.smallFonts]}>
            ...
            <View style={styles.grid}>
              ...
              {/* <View style={styles.flex}>
                <Text>Distributor ID: </Text>
                <Text style={styles.textRed}>{"0189765478678"}</Text>
              </View>

              <View style={styles.flex}>
                <Text>Phone No: </Text>
                <Text style={styles.textRed}>{"7015010279"}</Text>
              </View>

              <View style={styles.flex}>
                <Text></Text>
                <Text>Bill No: </Text>
                <Text style={styles.textRed}>{"05671VD0097"}</Text>
              </View> */}

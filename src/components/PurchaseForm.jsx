...
// {/* <form className="gap-6 flex flex-col w-full lg:w-1/2" onSubmit={handleSubmit}>
//       {/* for client Name */}
...
//           </label>
//           <select className="border-2 rounded-sm h-10 outline-none w-full cursor-pointer text-gray-400 bg-white px-3" name="adulteration"
...
//           </label>
//           <select className="border-2 rounded-sm h-10 outline-none w-full cursor-pointer text-gray-400 bg-white px-3" name="whatToDo" ref={ (el)=>refArray.current[7]=el }>
